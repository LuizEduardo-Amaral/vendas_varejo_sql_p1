...
2. **Configure o Banco de Dados**: Execute os scripts SQL fornecidos no arquivo `database_setup.sql` para criar e popular o banco de dados.
3. **Execute as Consultas**:  Use as consultas SQL fornecidas no arquivo `analysis_queries.sql` para realizar sua análise.
